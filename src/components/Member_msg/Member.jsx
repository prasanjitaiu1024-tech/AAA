...
const Member = ()=>{
    return(
        <><div className="members" name="About_us" id="members">
            ...
            {/* <!-- Header Section --> */}
            <header className="bg-green-300 text-white py-6">
            ...
            <section className="py-12">
                ...
                <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <h3 className="text-2xl font-bold mb-4 text-center text-cyan-400">Our Mission</h3>
                    <p className="text-white justify-center text-justify">
                ...
                <div className="mt-8">
                    <h3 className="text-2xl font-bold mb-4 text-center text-cyan-600">Our History</h3>
                    <p className="text-white justify-center text-justify">
            ...
            <section className=" py-12">
                <div className="container px-4">
                <h2 className="text-5xl font-semibold text-center mb-8 text-blue-400/50">Meet Our Team</h2>
